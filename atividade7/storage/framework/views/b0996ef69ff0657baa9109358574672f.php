...
<div class="container">
    ...
    <form action="<?php echo e(route('books.store.id')); ?>" method="POST" enctype="multipart/form-data">
        <?php echo csrf_field(); ?>
        <div class="mb-3">
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/luke/atividade3/atividades-web-2/atividade6/resources/views/books/create-id.blade.php ENDPATH**/ ?>